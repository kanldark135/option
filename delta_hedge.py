...
call_short = option.generate_hedge_df(call_short_k, hedge_interval, s, call_short_v, t, r, call_short_n, callput = 'call')
call_ext = option.generate_hedge_df(call_ext_k, hedge_interval, s, call_ext_v, t, r, call_ext_n, callput = 'call')

put_short = option.generate_hedge_df(put_short_k, hedge_interval, s, put_short_v, t, r, put_short_n, callput = 'put')
put_ext = option.generate_hedge_df(put_ext_k, hedge_interval, s, put_ext_v, t, r, put_ext_n, callput = 'put')

call_hedge = option.generate_hedge_df(call_hedge_k, hedge_interval, s, call_hedge_v, t, r, 1, callput = "call")
put_hedge = option.generate_hedge_df(put_hedge_k, hedge_interval, s, put_hedge_v, t, r, 1, callput = 'put')
